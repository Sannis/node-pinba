...
/**
 * PinbaRequest#setSchema(schema)
 * - schema (String): Script name.
 *
 * Setter for *schema* request property.
 * Default value: empty.
 **/
PinbaRequest.prototype.setSchema = function (schema) {
  this.schema = schema;
};
...
/**
 * PinbaRequest#tagSet(tag, value)
 * - tag (String): Tag name.
 * - value (String): Tag value.
 *
 * Set or update request tag value.
 **/
PinbaRequest.prototype.tagSet = function (tag, value) {
  this.tags[tag] = value;
};

/**
 * PinbaRequest#tagGet(tag)
 * - tag (String): Tag name.
 *
 * Get request tag value.
 **/
PinbaRequest.prototype.tagGet = function (tag) {
  return this.tags[tag];
};

/**
 * PinbaRequest#tagDelete(tag)
 * - tag (String): Tag name.
 *
 * Delete request tag value.
 **/
PinbaRequest.prototype.tagDelete = function (tag) {
  delete this.tags[tag];
};

/**
 * PinbaRequest#tagsGet()
 *
 * Get request tags with values.
 **/
PinbaRequest.prototype.tagsGet = function () {
  return this.tags;
};

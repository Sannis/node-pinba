...
var ProtoBufBuilder = ProtoBuf.loadJsonFile(require('path').join(__dirname, "../resources/pinba.json"));
var PinbaRequestProtoBufBuilder = ProtoBufBuilder.build("Pinba").Request;
/** internal
 * getPinbaRequestProtoBufBuilder()
 **/
exports.getPinbaRequestProtoBufBuilder = function getPinbaRequestProtoBufBuilder () {
  return PinbaRequestProtoBufBuilder;
};
...
Request.prototype.flush = function (config, callback) {
  ...
  var buffer;
  try {
    var PinbaRequestProtoBuf = new PinbaRequestProtoBufBuilder();
    PinbaRequestProtoBuf.set(data);
    buffer = PinbaRequestProtoBuf.toBuffer();
  } catch (err) {

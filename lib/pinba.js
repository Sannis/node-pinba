 ...
 * - override_data (Object): Data to override request one.
 ...
 **/
Request.prototype.flush = function (override_data, callback) {
  // Handle arguments
  if ((arguments.length === 1) && (typeof override_data === 'function')) {
    callback = override_data;
    override_data = {};
  }
 ...
 this.timersStop();
  ...
  // Override
  _.forOwn(override_data, function (value, name) {
    data[name] = value;
  });
